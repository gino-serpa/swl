...
countries ={'Afghanistan':  ['Afghanistan'],
            ...
            'Angola':       ['Angola'],
            'Anguilla':     ['Anguilla'],
            'Antigua & Barbuda':    ['Antigua & Barbuda','Antigua & Barbu'],
            ...
            'DR Congo':     ['DR Congo','Democratic Republic of the Congo',
                            'Republic of Congo','DEM REP CONGO', 'Rep Congo'],
            'Ecuador':      ['Ecuador','República del Ecuador'],
            'Egypt':        ['Egypt'],
            'El Salvador':  ['El Salvador'],
            'Equatorial Guinea': ['Equatorial Guinea','Equat Guinea'],
            'Eritrea':      ['Eritrea'],
            'Estonia':      ['Estonia'],
            ...
            'Ivory Coast':  ['Ivory Coast',"Côte d'Ivoire",'Cote Ivoire'],
            'Jamaica':      ['Jamaica'],
            ...
            'USA':          ['USA', 'Estados Unidos', 'United States','EE.UU',
                             'United States of América','EE. UU','EEUU','EE UU',
